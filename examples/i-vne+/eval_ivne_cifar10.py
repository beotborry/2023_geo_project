...
def lin_eval_I_VNE(args):
    ...
    dataset_train = torchvision.datasets.CIFAR10(args.datadir, train=True, transform=transform_train, download=True)
    ...
    dataset_valid = torchvision.datasets.CIFAR10(args.datadir, train=False, transform=transform_valid, download=True)
