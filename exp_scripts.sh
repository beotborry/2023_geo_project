...
# python -W ignore -u train_ivne_imagenet100.py --gpu_num 0,1,2,3 --datadir /home/juhyeon/data/Imagenet --cache_name 231213_ImageNet_10_vne_1.0_w_cropped_geodesic_c_1 --seed 0 --reg_type vne --batch_size 128 --epochs 100 --subclass_file ./subclass_imgnet10.csv --alpha_2 1.0 & wait
...
python -W ignore -u eval_ivne_imagenet100.py --gpu_num 0 --datadir /home/juhyeon/data/Imagenet --cache_name 231213_ImageNet_10_vne_1.0_w_cropped_geodesic_c_1 --seed 0 --reg_type vne --subclass_file ./subclass_imgnet10.csv --alpha_2 1.0 & wait

# Imagenet 50 Start
python -W ignore -u train_ivne_imagenet100.py --gpu_num 0,1,2,3 --datadir /home/juhyeon/data/Imagenet --cache_name 231214_ImageNet_50_geo_crop_corrected_alpha2_0.3_epochs_400 --seed 0 --reg_type geodesic_crop --batch_size 128 --epochs 400 --subclass_file ./subclass_imgnet50.csv --alpha_2 0.3 & wait 

python -W ignore -u eval_ivne_imagenet100.py --gpu_num 0 --datadir /home/juhyeon/data/Imagenet --cache_name 231214_ImageNet_50_geo_crop_corrected_alpha2_0.3_epochs_400 --seed 0 --reg_type geodesic_crop --subclass_file ./subclass_imgnet50.csv --alpha_2 0.3 & wait
